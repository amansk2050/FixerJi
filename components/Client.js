    ...
    <>
      ...
      <div className="flex sm:w-auto md:w-full sm:overflow-x-auto md:overflow-hidden  md:justify-around items-center">
        <div
          ...
          className=" sm:mr-5 md:w-[300px] sm:w-[600px] lg:w-[350px] md:h-[420px] lg:h-[500px] border border-black rounded-md bg-gray-800 hover:bg-[#8CE605]/60 transition-all duration-1000 flex flex-col justify-center items-center md:p-12  sm:py-8 "
        >
        ...
        <div
          ...
          className=" snap-center sm:mr-5 md:w-[300px] lg:w-[450px] sm:w-[600px]  md:h-[420px]  lg:h-[600px] border border-black rounded-md bg-gray-800 hover:bg-[#8CE605]/60 transition-colors duration-1000 flex flex-col justify-center items-center md:px-12 sm:py-8"
        >
          <div className=" w-[50px] h-[50px] border border-[#ffffff] rounded-full mb-2 ">
            <img
              src="https://avatars.dicebear.com/api/adventurer/your-custom-seed.svg"
