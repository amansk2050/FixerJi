  ...
  return (
    <div className="h-full">
      <div className="relative flex justify-center items-center h-20">
        <h1 className="absolute sm:top-[200px] md:top-[250px] font-bold uppercase font-oswald md:text-5xl text-[#8CE605] tracking-widest z-0">
          <span className="motion-safe:animate-pulse">{text}</span>
          <Cursor />
        </h1>
      </div>
      <div className="h-80 flex justify-center items-center">
        <p className="font-Noto tracking-wide font-semibold sm:text-md md:text-lg  text-stone-200 sm:pt-[65px] absolute md:top-[300px] sm:top-[250px] z-0 sm:px-16  md:p-6 mx-auto ">
          Because audits are way cheaper than hacks or bounties
        </p>
      </div>
      <div className="flex justify-around items-center sm:mt-8  md:w-4/12 md:mx-auto">
        {/* <button className="absolute top-[450px] text-[#8CE605] border-2 border-[#8CE605] rounded-[38px] px-10 py-5 uppercase font-oswald hover:bg-[#8CE605] hover:text-black transition-all  hover:scale-110 hover:ease-in-out duration-1000">
          Lets Talk
        </button> */}
        <button className="text-[#8CE605] border-2 border-[#8CE605] rounded-[38px] sm:px-10  py-5   uppercase font-oswald hover:bg-[#8CE605] hover:text-black transition-all  hover:scale-110 hover:ease-in-out duration-1000">
          hey
        </button>
        <button className="text-[#8CE605] border-2 border-[#8CE605] rounded-[38px] sm:px-10  py-5   uppercase font-oswald hover:bg-[#8CE605] hover:text-black transition-all  hover:scale-110 hover:ease-in-out duration-1000">
          man
